...
class Cyc_Trainer():
    ...
    #         # Save models checkpoints
            ...
            torch.save(self.netG_A2B.state_dict(), self.config['save_root'] + 'netG_A2B_batch_8.pth')
            ...
            torch.save(best_weights, self.config['save_root'] + 'best_model_weights_batch_8.pth')
    ...
    def test(self):
        ...
        # print(device)
        self.netG_A2B.load_state_dict(torch.load(self.config['save_root'] + 'best_model_weights_batch_8.pth', map_location='cpu'))
